...
export interface paths {
    ...
    "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/inits/{name}/_targets": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get intent targets for the specified namespaced Init. */
        get: operations["getTargetsBootstrapEdaNokiaComV1alpha1NamespaceInits"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/inits/{name}/_topology": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * @deprecated
         * @description Get the topology for the specified namespaced Init.  This API is deprecated and the POST
         *     API should be used instead.
         */
        get: operations["getTopologyBootstrapEdaNokiaComV1alpha1NamespaceInits"];
        put?: never;
        /** Retrieve the topology for the specified namespaced Init. */
        post: operations["postTopologyBootstrapEdaNokiaComV1alpha1NamespaceInits"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/managementrouters": {
        ...
        /**
         * list managementrouters in namespace
         * @description The resulting resources can optionally be a subset of the resource content by using the "fields" query parameter.
         */
    ...
    "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/managementrouters/{name}/_targets": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get intent targets for the specified namespaced ManagementRouter. */
        get: operations["getTargetsBootstrapEdaNokiaComV1alpha1NamespaceManagementrouters"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/managementrouters/{name}/_topology": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * @deprecated
         * @description Get the topology for the specified namespaced ManagementRouter.  This API is deprecated and the POST
         *     API should be used instead.
         */
        get: operations["getTopologyBootstrapEdaNokiaComV1alpha1NamespaceManagementrouters"];
        put?: never;
        /** Retrieve the topology for the specified namespaced ManagementRouter. */
        post: operations["postTopologyBootstrapEdaNokiaComV1alpha1NamespaceManagementrouters"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        "com.nokia.eda.bootstrap.v1alpha1.Init": {
            alarms?: components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.Init_alarms"];
            /** @default bootstrap.eda.nokia.com/v1alpha1 */
            apiVersion: string;
            deviations?: components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.Init_deviations"];
            /** @default Init */
            kind: string;
        ...
        "com.nokia.eda.bootstrap.v1alpha1.Init_alarms": {
            /** Format: int64 */
        ...
        "com.nokia.eda.bootstrap.v1alpha1.Init_deviations": {
            /** Format: int64 */
        ...
        "com.nokia.eda.bootstrap.v1alpha1.ManagementRouter": {
            alarms?: components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.ManagementRouter_alarms"];
            /** @default bootstrap.eda.nokia.com/v1alpha1 */
            apiVersion: string;
            deviations?: components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.ManagementRouter_deviations"];
        ...
        "com.nokia.eda.bootstrap.v1alpha1.ManagementRouter_alarms": {
            /** Format: int64 */
            readonly critical?: number;
            /** Format: int64 */
            readonly major?: number;
        ...
        "com.nokia.eda.bootstrap.v1alpha1.ManagementRouter_deviations": {
            /** Format: int64 */
            readonly count?: number;
        };
...
export interface operations {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    ...
                    "application/yaml": components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.InitList"];
                };
            };
            /** @description Details of an error in response to an API REST request. */
            default: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    ...
                    "application/yaml": components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.ManagementRouterList"];
                };
            };
            /** @description Details of an error in response to an API REST request. */
            default: {
    ...
    createBootstrapEdaNokiaComV1alpha1NamespaceInits: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.Init"];
                    "application/yaml": components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.Init"];
                };
            };
            /** @description Details of an error in response to an API REST request. */
            default: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    ...
                    "application/yaml": components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.Init_DeletedResources"];
                };
            };
            /** @description Details of an error in response to an API REST request. */
            default: {
    ...
    getTargetsBootstrapEdaNokiaComV1alpha1NamespaceInits: {
        parameters: {
            query?: {
                /** @description client information for streaming request */
                eventclient?: string;
        ...
        requestBody?: never;
        responses: {
            /** @description Returns the list of intent targets for the specified Init resource. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getTopologyBootstrapEdaNokiaComV1alpha1NamespaceInits: {
        parameters: {
            query?: {
    ...
    postTopologyBootstrapEdaNokiaComV1alpha1NamespaceInits: {
        parameters: {
            query?: {
                /** @description client information for streaming request */
                eventclient?: string;
    ...
    createBootstrapEdaNokiaComV1alpha1NamespaceManagementrouters: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.ManagementRouter"];
                    "application/yaml": components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.ManagementRouter"];
                };
            };
            /** @description Details of an error in response to an API REST request. */
            default: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    ...
                    "application/yaml": components["schemas"]["com.nokia.eda.bootstrap.v1alpha1.ManagementRouter_DeletedResources"];
                };
            };
            /** @description Details of an error in response to an API REST request. */
            default: {
    ...
    getTargetsBootstrapEdaNokiaComV1alpha1NamespaceManagementrouters: {
        parameters: {
            query?: {
                /** @description client information for streaming request */
                eventclient?: string;
        ...
        requestBody?: never;
        responses: {
            /** @description Returns the list of intent targets for the specified ManagementRouter resource. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getTopologyBootstrapEdaNokiaComV1alpha1NamespaceManagementrouters: {
        parameters: {
            query?: {
                /** @description the type of topology to retrieve */
                type?: "children" | "parents" | "childrenAndParents" | "dependentCrs";
    ...
    postTopologyBootstrapEdaNokiaComV1alpha1NamespaceManagementrouters: {
        parameters: {
            query?: {
                /** @description client information for streaming request */
                eventclient?: string;
